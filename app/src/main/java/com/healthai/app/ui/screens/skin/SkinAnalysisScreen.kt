...
fun SkinAnalysisScreen(navController: NavController) {
    ...
    LaunchedEffect(key1 = true) {
        ...
        navController.navigate(NavRoutes.SkinResult) {
    ...
    Scaffold(containerColor = Color(0xFF0B1221)) { paddingValues ->
        Column(
            ...
            Text(
                text = "Analyzing Your Skin Photo...",
                color = Color.White,
                fontSize = 20.sp,
            ...
            Text(
                text = "AI patterns, rang, aur banawat ki jaanch kar raha hai.",
                color = Color.Gray,
                fontSize = 14.sp,
                textAlign = TextAlign.Center
            )
...
fun SkinAnalysisAnimation() {
    ...
    Canvas(modifier = Modifier.size(150.dp)) {
        drawArc(
            color = Color(0xFF00E676), // Green theme color
            startAngle = angle,
            sweepAngle = 120f,
            useCenter = false,
